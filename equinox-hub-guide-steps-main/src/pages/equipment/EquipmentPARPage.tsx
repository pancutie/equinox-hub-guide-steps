  ...
  return (
    <MainLayout>
      <div className="flex items-center gap-3 mb-4">
        ...
        <h1 className="text-2xl font-bold text-purple-800 dark:text-purple-300">Equipment / PAR</h1>
      </div>
      ...
      <Card className="mb-6 border shadow-sm bg-white dark:bg-gray-900 border-purple-100 dark:border-purple-800">
        <CardContent className="pt-6">
          ...
          <div className="rounded-md border border-purple-100 dark:border-purple-800 overflow-hidden shadow-sm">
            <Table>
              <TableCaption className="dark:text-gray-400">List of all PAR equipment in the inventory</TableCaption>
              <TableHeader className="bg-purple-50 dark:bg-gray-800/50">
                <TableRow className="dark:border-purple-800">
                  <TableHead className="text-purple-700 dark:text-purple-300">Property No.</TableHead>
                  ...
                  <TableHead className="text-purple-700 dark:text-purple-300">Date Acquired</TableHead>
                  <TableHead className="text-purple-700 dark:text-purple-300">Amount</TableHead>
                  <TableHead className="text-purple-700 dark:text-purple-300">PAR No.</TableHead>
              ...
              <TableBody className="dark:bg-gray-900">
                {filteredEquipment.length > 0 ? (
                  filteredEquipment.map((item) => (
                    <TableRow key={item.id} className="hover:bg-purple-50/50 dark:border-purple-800 dark:hover:bg-gray-800/50">
                      ...
                      <TableCell className="dark:text-gray-200">{item.dateAcquired}</TableCell>
                      <TableCell className="dark:text-gray-200">₱{item.amount.toLocaleString()}</TableCell>
                      <TableCell className="dark:text-gray-200">{item.parNo}</TableCell>
                      <TableCell>
                  ...
                  <TableRow>
                    <TableCell colSpan={9} className="text-center py-8 text-muted-foreground dark:text-gray-500">
