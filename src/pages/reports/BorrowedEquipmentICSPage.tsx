...
// Sample data for borrowed equipment ICS
const borrowedEquipmentICS = [
  { 
    id: 1, 
    name: "Laptop", 
    serialNumber: "L12345", 
...
const BorrowedEquipmentICSPage = () => {
  const [searchTerm, setSearchTerm] = useState("");
  
  const filteredEquipment = borrowedEquipmentICS.filter(
    (item) =>
    ...
    <MainLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <h1 className="text-2xl font-bold">Borrowed Equipment (ICS)</h1>
...
export default BorrowedEquipmentICSPage;
