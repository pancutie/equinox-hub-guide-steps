...
// Sample data for overdue equipment ICS
const overdueEquipmentICS = [
  { 
    id: 1, 
    name: "Laptop", 
    serialNumber: "L12345", 
...
const OverdueEquipmentICSPage = () => {
  const [searchTerm, setSearchTerm] = useState("");
  
  const filteredEquipment = overdueEquipmentICS.filter(
    (item) =>
...
export default OverdueEquipmentICSPage;
